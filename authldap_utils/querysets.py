"""
Models for the authldap_utils application.
"""
#######################################################################
...
class BaseCustomQuerySet(models.query.QuerySet):
    ...
    def search(self, *criteria):
        ...
        terms = [unicode(c) for c in criteria]
        if len(terms) == 1:
            terms = terms[0].split()
        ...
        orm_lookups = [
            construct_search(unicode(search_field))
...
# class Authldap_UtilsModelQuerySet(BaseCustomQuerySet):
#     """
